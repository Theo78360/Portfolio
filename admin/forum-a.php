...
<body>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1>Forum pour jeux-vidéos</h1><br>
                <p class="lead text-muted">Ce premier projet de deuxième année de BTS SIO avait pour but de mettre en place un forum de jeux-vidéos qui comprenait une inscription et la possibilité de mettre des commantaires ainsi que de les modifier et supprimer.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="card mb-4 shadow-sm">
                            <a class="zoombox  " href='../images/forum.png'><image  src='../images/forum.png' width='350' height='175'></image></a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                           <a class="zoombox " href='../images/forum2.png'><image  src='../images/forum2.png' width='350' height='175'></image></a> 
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            <a class="zoombox " href='../images/forum3.png'><image  src='../images/forum3.png' width='350' height='175'></image></a>
                        </div>
                    </div>
