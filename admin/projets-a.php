    ...
    <header>
        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
            <div class="container d-flex justify-content-between">
                ...
                <a href="cv-a.php"><strong>Mes projets</strong></a>
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="paris-a.php"><button  type="button" class="btn btn-sm btn-outline-secondary">Voir</button></a>
                        ...
                        <div class="card mb-4 shadow-sm">
                           <a class="zoombox w400 h400" href='../images/forum.png'><image  src='../images/forum.png' width='350' height='175'></image></a> 
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="forum-a.php"><button type="button" class="btn btn-sm btn-outline-secondary">Voir</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                       <a href="villiers-a.php"><button type="button" class="btn btn-sm btn-outline-secondary">Voir</button></a> 
                                    </div>
                                </div>
                            </div>
                        </div>
